function [Vol_out] = V_epifisis_tibia(V_seg)
    ...
    Vol_epifisiario = zeros(size(Tibia));
    ...
    for k=min(v1):max(v1)
        ...
        for i=1:length(lista_columnas_fisis)
            ...
            filas_columnas_correctas = row_h(ind2);
            Vol_epifisiario(filas_columnas_correctas(filas_columnas_correctas < altura_min_fisis)...
                ,lista_columnas_fisis(i),k) = 1;

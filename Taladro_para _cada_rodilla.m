...
lista = [V_seg.femur.fisis,V_seg.femur.bones,V_seg.tibia.fisis,V_seg.tibia.bonesa,V_seg.perone.fisis,V_seg.perone.bones];
...
btn1 = uicontrol('Style', 'pushbutton', 'String', 'RESET Z FEMUR',...
...
if (answer1(3)/pixel) > size(V_seg.vol.orig,3)
    bien = 0

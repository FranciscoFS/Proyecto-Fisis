...
% Last Modified by GUIDE v2.5 11-Apr-2020 22:18:58
...
disco = str2double(get(handles.disco,'string'));
se = strel('disk',disco,8);
...
function disco_Callback(hObject, eventdata, handles)
% hObject    handle to disco (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of disco as text
%        str2double(get(hObject,'String')) returns contents of disco as a double


% --- Executes during object creation, after setting all properties.
function disco_CreateFcn(hObject, eventdata, handles)
% hObject    handle to disco (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called

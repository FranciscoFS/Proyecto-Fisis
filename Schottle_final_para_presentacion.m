function V_seg = Schottle_final_para_presentacion(V_seg)
...
imshow(rx_femur,[]);
hold on
plot([P1(2),P2(2)],[P1(1),P2(1)],'LineWidth',1.5,'color', 'w')
plot([P3(2),P4(2)],[P3(1),P4(1)],'LineWidth',1.5,'color', 'w')
plot([P5(2),P6(2)],[P5(1),P6(1)],'LineWidth',1.5,'color', 'w')
